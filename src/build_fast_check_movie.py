...
def main():
    ...
    for part in timekeeper['parts']:
        ...
        for chapter in part['chapters']:
            ...
            for page in chapter['pages']:
                page_video_clips.append(ImageClip(page['image_path']).set_fps(FPS).set_start(page['start']).set_duration(page['duration']))
    ...
    vu.write_video(f'fast_check_movie_tmp.mp4', concatenate_videoclips(part_video_clips), fps=FPS)
